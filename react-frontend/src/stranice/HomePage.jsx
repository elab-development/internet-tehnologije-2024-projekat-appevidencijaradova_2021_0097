                    ...
                    <div className="row">
                        <div className="col-lg-4 offset-lg-2">
                            ...
                            <p className="text-justify">
                                ...
                                Korišćenjem najnovije tehnologije pružamo sveobuhvatnu
                                analizu potencijalnih sličnosti,
                                omogućavajući edukatorima da donose informisane odluke.
                            </p>
                        </div>
                        <div className="col-lg-4">
                            <img
                                src="/slikazaHomePage.jpg"
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            ...
                            <p className="text-justify">
                                ...
                                rada vaše institucije u bezbednim rukama.
                            </p>
                        </div>
                    </div>
                </section>
